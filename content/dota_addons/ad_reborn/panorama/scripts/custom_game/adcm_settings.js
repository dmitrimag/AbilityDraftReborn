...
(function() {
	...
	GameUI.CustomUIConfig().team_colors[DOTATeam_t.DOTA_TEAM_GOODGUYS] = "#66ff66;";
	GameUI.CustomUIConfig().team_colors[DOTATeam_t.DOTA_TEAM_BADGUYS ] = "#ff6666;";
	...
	GameUI.CustomUIConfig().team_colors[1] = "#666666;"; // spectator team

	GameUI.CustomUIConfig().team_select = {
		bShowSpectatorTeam: true // look at "dota 2 beta\content\dota\panorama\scripts\custom_game\team_select.js"
	}
